...
class JsonSerializerWithObjectSerialization(json.JSONEncoder):
    def default(self, o):
        try:
            return vars(o)
        except TypeError:
            return repr(o)
json_serializer = JsonSerializerWithObjectSerialization(indent=2)
...
class JSON(Savable):
    ...
    def serialize(self: ..., *args, **kwargs):
        return json_serializer.encode(self)
